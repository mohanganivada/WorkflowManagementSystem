...
INSERT INTO `cview_services_master` VALUES (432,'experience 0-1 years','package description','admin','2023-02-27 14:25:00',NULL,3000),(433,'experience 1-5 years','package description','admin','2023-02-27 14:25:00',NULL,4000),(434,'experience 5-10 years','package description','admin','2023-02-27 14:25:00',NULL,5500),(435,'experience 10+ years','package description','admin','2023-02-27 14:25:00',NULL,5999),(436,'student-undergraduation','package description','admin','2023-02-27 14:25:00',NULL,4200),(437,'student-graduation','package description','admin','2023-02-27 14:25:00',NULL,5150),(438,'student-phd/mba/doctorate','package description','admin','2023-02-27 14:25:00',NULL,5800),(439,'visa application','package description','admin','2023-02-27 14:25:00',NULL,6200);
...
INSERT INTO `tbl_report1_temp` VALUES ('moorthy',200,1,'n','moorthy@gmail.com',9000000001,2,3),('srinivas',100,1,'c','srinuc@gmail.com',9000000000,7,2),('srinivas',100,0,'c','srinuc@gmail.com',9000000000,2,2),('sagar',101,0,'munjam','sagar@gmail.com',9652502657,2,2),('karthik',102,0,'swaminathan','contact@karthikswaminathan.com',8096675401,2,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=1031 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table is created to have Resume and its status';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_resume` VALUES (1027,2,2,200,300,'2023-02-27 10:53:28',11,NULL,436),(1028,307,7,100,200,'2023-02-27 14:59:59',3,NULL,435),(1030,1,1,200,300,'2023-02-28 11:25:29',11,NULL,438);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table is to handle Un registered user who comes to check their ATS. He may opt for our services and we need to move them into regular user later.\nThere will not be any user name and password for this person.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_un_registered_user` VALUES (1,NULL,NULL,'pothurajulakarthik50@gmail.com',NULL,'pothurajulakarthik50@gmail.com','2023-02-23 12:35:06'),(2,NULL,NULL,'pothurajulakarthik50@gmail.com',NULL,'pothurajulakarthik50@gmail.com','2023-02-27 18:03:42');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='User inputs of any activity shall be stored here.\n1. Indoor 2.outdoor 3.sports 4.Games 5.Papers 6.Awards 7.Clubs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_activities` VALUES (2,302,'singing','','','','','','','','','302','2023-02-23 12:41:34'),(3,307,'listening mujic','musicccc','none','0','none','telugu, english, hindi','mysql workbench','java,python','','307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table is created for storing Customer Education Details. The user ID is foreign key referred to Tbl_User_Master';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_education` VALUES (3,307,'ssc','chaitanya techno school','hyd','india','10','2022-01-01','2022-01-01','offline','307','2023-02-27 14:55:32'),(4,307,'intermediate','chatanya junior college','hyd','india','93','2022-01-01','2022-01-01','offline','307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table sotres data regarding user experience';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_experience` VALUES (2,302,'vista','developer','2022-01-01','2022-01-01','','302','2023-02-23 12:41:33'),(3,307,'vista','intern','2022-01-01','2022-01-01','fresher','307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This is a User Master table where initial details shall be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table is to store profissional summary of user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_prof` VALUES (2,302,'i have 3 years of carreer in the it and worked on AI and ML',NULL,'302','2023-02-23 12:41:34'),(3,307,'no professional journey',NULL,'307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table stores data about the user projects - multiples';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_projects` VALUES (2,302,'major','leader','','major project in college','group','2022-01-01','2022-01-01','302','2023-02-23 12:41:33'),(3,307,'resume scanner','team leader','python','obtaining skills','college','2022-01-01','2022-01-01','307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table stores data regarding the Social Media links like linkdin, twitter, facebook...etc';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_scocial_media` VALUES (2,302,'instagram','FTUFT','302','2023-02-23 12:41:34'),(3,307,'instagram','aashritha_19','307','2023-02-27 14:55:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table stores data regarding individual user Technical Skills';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user_tech_skills` VALUES (2,302,'django expert','302','2023-02-23 12:41:34'),(3,307,'python AI ML chatgpt','307','2023-02-27 14:55:32');
...
-- Dump completed on 2023-02-28 12:36:00
