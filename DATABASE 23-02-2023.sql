...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Service master shall have the data about the services we are offering to our customer there shall be a sub master for further division of services';
...
) ENGINE=InnoDB AUTO_INCREMENT=1026 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table is created to have Resume and its status';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_resume` VALUES (1024,1,1,100,200,'2023-02-23 15:23:00',3,'i need changes in education details asasp'),(1025,302,7,101,200,'2023-02-23 12:44:20',3,NULL);
...
INSERT INTO `tbl_user_activities` VALUES (1,1,'travelling','i love travelling','','','','','','','','1','2023-02-23 14:44:28'),(2,302,'singing','','','','','','','','','302','2023-02-23 12:41:34');
...
INSERT INTO `tbl_user_education` VALUES (1,1,'ssc','zphs','Mancherial','India','80','2022-01-01','2022-01-01','offline','1','2023-02-23 14:44:28'),(2,302,'ssc','th','h','hh','H','2022-01-01','2022-01-01','FTH','302','2023-02-23 12:41:33');
...
INSERT INTO `tbl_user_experience` VALUES (1,1,'vista','developer','2022-01-01','2022-01-01','fresher','1','2023-02-23 14:44:28'),(2,302,'vista','developer','2022-01-01','2022-01-01','','302','2023-02-23 12:41:33');
...
INSERT INTO `tbl_user_prof` VALUES (1,1,'i have 3 years of carreer in the it and worked on AI and ML',NULL,'1','2023-02-23 14:44:28'),(2,302,'i have 3 years of carreer in the it and worked on AI and ML',NULL,'302','2023-02-23 12:41:34');
...
INSERT INTO `tbl_user_projects` VALUES (1,1,'web ecommerce','intern','AI-ML-NLP','major project in college','college','2022-01-01','2022-01-01','1','2023-02-23 14:44:28'),(2,302,'major','leader','','major project in college','group','2022-01-01','2022-01-01','302','2023-02-23 12:41:33');
...
INSERT INTO `tbl_user_scocial_media` VALUES (1,1,'instagram','thehimalayandreamer','1','2023-02-23 14:44:28'),(2,302,'instagram','FTUFT','302','2023-02-23 12:41:34');
...
INSERT INTO `tbl_user_tech_skills` VALUES (1,1,'django expert','1','2023-02-23 14:44:28'),(2,302,'django expert','302','2023-02-23 12:41:34');
...
-- Dump completed on 2023-02-23 17:26:14
